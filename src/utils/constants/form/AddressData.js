    ...
    districts: [
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "MORANG_PATHARI_SANISHRARE_MUN",
            label: "पथरी शनिश्चरे नगरपालिका",
          },
          ...
          {
            value: "MORANG_SUNDARAHARAICHA_MUN",
            label: "सुन्दरहरैचा नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "SUNSARI_BHOKRAHA_NARSIHA_MUN",
            label: "भोक्राहा नरसिंह गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DHANKUTA_CHHATHAR_JORPATI_MUN",
            label: "छथर जोरपाटी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "TEHRATHUM_MENCHHAYAYEM_MUN",
            label: "मेन्छयायेम गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "SANKHUWASABHA_DHARMADEWI_MUN",
            label: "धर्मदेवी नगरपालिका",
          },
          ...
          {
            value: "SANKHUWASABHA_SABHAPOKHARI_MUN",
            label: "सभापोखरी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "BHOJPUR_TEMKEMAIYUNG_MUN",
            label: "टेम्केमैयुङ गाउँपालिका",
          },
          {
            value: "BHOJPUR_RAMPRASAD_RAI_MUN",
            label: "रामप्रसाद राई गाउँपालिका",
          },
          { value: "BHOJPUR_ARUN_MUN", label: "अरुण गाउँपालिका" },
          { value: "BHOJPUR_PAUWAADUNGMA_MUN", label: "पौवादुङमा गाउँपालिका" },
          {
            value: "BHOJPUR_SALPAASILICHHO_MUN",
            label: "साल्पासिलिछो गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "SOLUKHUMBU_SOLUDUDHKUNDA_MUN",
            label: "सोलुदुधकुण्ड नगरपालिका",
          },
          {
            value: "SOLUKHUMBU_MAPYA_DUDHKOSI_MUN",
            label: "माप्य दुधकोशी गाउँपालिका",
          },
          {
            value: "SOLUKHUMBU_KHUMWU_PASANGLHAMU_MUN",
            label: "खुम्वु पासाङल्हमु गाउँपालिका",
          },
          {
            value: "SOLUKHUMBU_THULUNG_DUDHKOSI_MUN",
            label: "थुलुङ दुधकोशी गाउँपालिका",
          },
          {
            value: "SOLUKHUMBU_NECHASALYAN_MUN",
            label: "नेचासल्यान गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "OKHALDHUNGA_SIDDHICHARAN_MUN",
            label: "सिद्दिचरण नगरपालिका",
          },
          {
            value: "OKHALDHUNGA_KHIJIDEMBA_MUN",
            label: "खिजिदेम्बा गाउँपालिका",
          },
          {
            value: "OKHALDHUNGA_CHAMPADEWI_MUN",
            label: "चम्पादेवी गाउँपालिका",
          },
          {
            value: "OKHALDHUNGA_CHISHANGKHUGADI_MUN",
            label: "चिशंखुगढी गाउँपालिका",
          },
          {
            value: "OKHALDHUNGA_MANEBHANGYANG_MUN",
            label: "मानेभञ्याङ गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "KHOTANG_HALESI_TUWACHUNG_MUN",
            label: "हलेसी तुवाचुङ नगरपालिका",
          },
          {
            value: "KHOTANG_DIKTEL_RUPAKOT_MAJHUWAGADI_MUN",
            label: "दिक्तेल रुपाकोट मझुवागढी नगरपालिका",
          },
          ...
          {
            value: "KHOTANG_DIPRUNG_CHUICHUMMA_MUN",
            label: "दिप्रुङ चुइचुम्मा गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "UDAYAPUR_CHAUDANDIGADI_MUN",
            label: "चौदण्डीगढी नगरपालिका",
          },
          ...
          {
            value: "UDAYAPUR_LIMCHUNGBUNG_MUN",
            label: "लिम्चुङ्बुङ गाउँपालिका",
          },
        ],
      },
    ],
    ...
    districts: [
      //8 districts
      {
        ...
        palikas: [
          ...
          {
            value: "SAPTARI_HANUMANNAGAR_KANGKALINI_MUN",
            label: "हनुमाननगर कङ्‌कालिनी नगरपालिका",
          },
          { value: "SAPTARI_SAPTAKOSI_MUN", label: "सप्तकोशी नगरपालिका" },
          {
            value: "SAPTARI_AGNISAIR_KRISHNASARAWAN_MUN",
            label: "अग्निसाइर कृष्णासरवन गाउँपालिका",
          },
          ...
          {
            value: "SAPTARI_TILATHI_KOILADI_MUN",
            label: "तिलाठी कोईलाडी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "SIRAHA_LAXMIPUR_PATARI_MUN",
            label: "लक्ष्मीपुर पतारी गाउँपालिका",
          },
          { value: "SIRAHA_NARAHA_MUN", label: "नरहा गाउँपालिका" },
          {
            value: "SIRAHA_SANKHUWANANKARAKATTI_MUN",
            label: "सखुवानान्कारकट्टी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "DHANUSA_JANAKPURDHAM_MUN",
            label: "जनकपुरधाम उपमहानगरपालिका",
          },
          {
            value: "DHANUSA_KSHIRESHWORNATH_MUN",
            label: "क्षिरेश्वरनाथ नगरपालिका",
          },
          {
            value: "DHANUSA_GANESHMAN_CHARNATH_MUN",
            label: "गणेशमान चारनाथ नगरपालिका",
          },
          ...
          {
            value: "DHANUSA_MITHILA_BIHARI_MUN",
            label: "मिथिला बिहारी नगरपालिका",
          },
          ...
          {
            value: "DHANUSA_MUKHIYAPATTI_MUSAHARMIYA_MUN",
            label: "मुखियापट्टी मुसहरमिया गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "MAHOTTARI_RAMGOPALPUR_MUN",
            label: "रामगोपालपुर नगरपालिका",
          },
          {
            value: "MAHOTTARI_MANARA_SHISAWA_MUN",
            label: "मनरा शिसवा नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "RAUTAHAT_DEWAHI_GONAHI_MUN",
            label: "देवाही गोनाही नगरपालिका",
          },
          ...
          {
            value: "RAUTAHAT_MADHAWA_NARAYAN_MUN",
            label: "माधव नारायण नगरपालिका",
          },
          { value: "RAUTAHAT_MAULAPUR_MUN", label: "मौलापुर नगरपालिका" },
          {
            value: "RAUTAHAT_FATUWABIJAYAPUR_MUN",
            label: "फतुवाबिजयपुर नगरपालिका",
          },
          ...
          {
            value: "RAUTAHAT_DURGA_BHAGAWATI_MUN",
            label: "दुर्गा भगवती गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "BARA_JITPUR_SIMARA_MUN",
            label: "जीतपुर सिमरा उपमहानगरपालिका",
          },
          ...
          {
            value: "BARA_AADARSHA_KOTAWAL_MUN",
            label: "आदर्श कोटवाल गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "PARSA_PAKAHA_MAINAPUR_MUN",
            label: "पकाहा मैनपुर गाउँपालिका",
          },
          { value: "PARSA_BINDABASINI_MUN", label: "बिन्दबासिनी गाउँपालिका" },
          {
            value: "PARSA_SAKHUWA_PRASAUNI_MUN",
            label: "सखुवा प्रसौनी गाउँपालिका",
          },
          {
            value: "PARSA_PATERWA_SUGAULI_MUN",
            label: "पटेर्वा सुगौली गाउँपालिका",
          },
    ...
    districts: [
      {
        ...
        palikas: [
          ...
          {
            value: "SINDHULI_HARIHARPURGADI_MUN",
            label: "हरिहरपुरगढी गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "RAMECHHAP_GOKULDHUNGA_MUN",
            label: "गोकुलगङ्गा गाउँपालिका",
          },
          { value: "RAMECHHAP_DORAMBA_MUN", label: "दोरम्बा गाउँपालिका" },
          {
            value: "RAMECHHAP_LIKHU_TAMAKOSHI_MUN",
            label: "लिखु तामाकोशी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "SINDHUPALCHOK_CHAUTARA_SANGACHOKGADI_MUN",
            label: "चौतारा साँगाचोकगढी नगरपालिका",
          },
          {
            value: "SINDHUPALCHOK_BAHRAWISE_MUN",
            label: "बाह्रविसे नगरपालिका",
          },
          { value: "SINDHUPALCHOK_MELAMCHI_MUN", label: "मेलम्ची नगरपालिका" },
          {
            value: "SINDHUPALCHOK_INDRAWATI_MUN",
            label: "ईन्द्रावती गाउँपालिका",
          },
          { value: "SINDHUPALCHOK_JUGAL_MUN", label: "जुगल गाउँपालिका" },
          {
            value: "SINDHUPALCHOK_PACHPOKHARI_THANGPAL_MUN",
            label: "पाँचपोखरी थाङपाल गाउँपालिका",
          },
          { value: "SINDHUPALCHOK_BALEFI_MUN", label: "बलेफी गाउँपालिका" },
          {
            value: "SINDHUPALCHOK_BHOTEKOSHI_MUN",
            label: "भोटेकोशी गाउँपालिका",
          },
          {
            value: "SINDHUPALCHOK_LISANGKHU_PAKHAR_MUN",
            label: "लिसङ्खु पाखर गाउँपालिका",
          },
          { value: "SINDHUPALCHOK_SUNKOSHI_MUN", label: "सुनकोशी गाउँपालिका" },
          { value: "SINDHUPALCHOK_HELAMBU_MUN", label: "हेलम्बु गाउँपालिका" },
          {
            value: "SINDHUPALCHOK_TRIPURASUNDARI_MUN",
            label: "त्रिपुरासुन्दरी गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "KABHRE_CHURIDEURALI_MUN",
            label: "चौंरीदेउराली गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "BHAKTAPUR_CHAGUNARAYAN_MUN",
            label: "चाँगुनारायण नगरपालिका",
          },
          { value: "BHAKTAPUR_BHAKTAPUR_MUN", label: "भक्तपुर नगरपालिका" },
          {
            value: "BHAKTAPUR_MADHYAPUR_THIMI_MUN",
            label: "मध्यपुर थिमी नगरपालिका",
          },
          {
            value: "BHAKTAPUR_SURYABINAYAK_MUN",
            label: "सूर्यविनायक नगरपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          {
            value: "KATHMANDU_KATHMANDU_MUN",
            label: "काठमाण्डौं महानगरपालिका",
          },
          {
            value: "KATHMANDU_KAGESHOWRI_MANOHARA_MUN",
            label: "कागेश्वरी मनोहरा नगरपालिका",
          },
          { value: "KATHMANDU_KRITIPUR_MUN", label: "कीर्तिपुर नगरपालिका" },
          {
            value: "KATHMANDU_GOKARNESHOWER_MUN",
            label: "गोकर्णेश्वर नगरपालिका",
          },
          {
            value: "KATHMANDU_CHANDRAGIRI_MUN",
            label: "चन्द्रागिरी नगरपालिका",
          },
          ...
          {
            value: "KATHMANDU_BUDANILAKANTHA_MUN",
            label: "बुढानिलकण्ठ नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "RASUWA_AAMACHHODINGMO_MUN",
            label: "आमाछोदिङमो गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DHADING_NETRAWATI_DABAJONG_MUN",
            label: "नेत्रावती डबजोङ गाउँपालिका",
          },
          {
            value: "DHADING_BENIGHAT_RORANG_MUN",
            label: "बेनीघाट रोराङ्ग गाउँपालिका",
          },
          { value: "DHADING_RUWI_VYALI_MUN", label: "रुवी भ्याली गाउँपालिका" },
          { value: "DHADING_SIDDHALEKH_MUN", label: "सिद्धलेक गाउँपालिका	" },
          {
            value: "DHADING_TRIPURASUNDARI_MUN",
            label: "त्रिपुरासुन्दरी गाउँपालिका	",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "MAKAWANPUR_INDRASAROBAR_MUN",
            label: "इन्द्रसरोबर गाउँपालिका",
          },
          ...
          {
            value: "MAKAWANPUR_MAKAWANPURGADI_MUN",
            label: "मकवानपुरगढी गाउँपालिका",
          },
          { value: "MAKAWANPUR_MANAHARI_MUN", label: "मनहरी गाउँपालिका" },
          {
            value: "MAKAWANPUR_RAKSIRANG_MUN",
            label: "राक्सिराङ्ग गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "CHITWAN_ICHCHHAKAMANA_MUN",
            label: "इच्छाकामना गाउँपालिका",
          },
        ],
      },
    ],
    ...
    districts: [
      {
        ...
        palikas: [
          ...
          {
            value: "GORAKHA_BARPAK_SULIKOT_MUN",
            label: "बारपाक सुलिकोट गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          { value: "LAMJUNG_RAINAS_MUN", label: "राइनास नगरपालिका" },
          { value: "LAMJUNG_SUNDARBAJAR_MUN", label: "सुन्दरबजार नगरपालिका" },
          {
            value: "LAMJUNG_KWHOLASOTHAR_MUN",
            label: "क्व्होलासोथार गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "TANAHU_SHUKLAGANDAKI_MUN",
            label: "शुक्लागण्डकी नगरपालिका",
          },
          {
            value: "TANAHU_AABUKHAIRAHANI_MUN",
            label: "आँबुखैरेनी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "SYANGJA_ARJUNCHAUPARI_MUN",
            label: "अर्जुनचौपारी गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "KASKI_MACHHAPUCHCHHRE_MUN",
            label: "माछापुच्छ्रे गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "MANANG_MANANG_NGISYANG_MUN",
            label: "मनाङ ङिस्याङ गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "MUSTANG_LOGHEKAR_DAMODARKUNDA_MUN",
            label: "लो-घेकर दामोदरकुण्ड गाउँपालिका",
          },
          { value: "MUSTANG_LOMANTHANG_MUN", label: "लोमन्थाङ गाउँपालिका" },
          {
            value: "MUSTANG_WARAGUNG_MUN",
            label: "वारागुङ मुक्तिक्षेत्र गाउँपालिका",
          },
        ],
      },
      {
      ...
      {
        value: "nawalparasiSustaPurwa",
        label: "नवलपरासी (बर्दघाट सुस्ता पूर्व)",
        palikas: [
          {
            value: "NAWALPARASI_SUSTA_PURWA_KAWASOTI_MUN",
            label: "कावासोती नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_GAIDAKOT_MUN",
            label: "गैडाकोट नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_DEWACHULI_MUN",
            label: "देवचुली नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_MADHYAWINDU_MUN",
            label: "मध्यविन्दु नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_BAUDIKALI_MUN",
            label: "बौदीकाली गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWABULINGTAR_MUN",
            label: "बुलिङटार गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_WINAYI_MUN",
            label: "विनयी त्रिवेणी गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PURWA_HUPSEKOT_MUN",
            label: "हुप्सेकोट गाउँपालिका",
          },
        ],
      },
    ],
    ...
    districts: [
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "PALPA_RAINADEWI_CHHAHARA_MUN",
            label: "रैनादेवी छहरा गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          ...
          {
            value: "RUPANDEHI_LUMBINI_SANSKRITIK_MUN",
            label: "लुम्बिनी सांस्कृतिक नगरपालिका",
          },
          { value: "RUPANDEHI_SAINAMAINA_MUN", label: "सैनामैना नगरपालिका" },
          {
            value: "RUPANDEHI_SIDDARTHANAGAR_MUN",
            label: "सिद्धार्थनगर नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "KAPILWASTHU_KAPILWASTHU_MUN",
            label: "कपिलवस्तु नगरपालिका",
          },
          {
            value: "KAPILWASTHU_BUDDHABHUMI_MUN",
            label: "बुद्धभुमी नगरपालिका",
          },
          { value: "KAPILWASTHU_SHIWARAJ_MUN", label: "शिवराज नगरपालिका" },
          {
            value: "KAPILWASTHU_MAHARAJGANG_MUN",
            label: "महाराजगंज नगरपालिका",
          },
          {
            value: "KAPILWASTHU_KRISHNANAGAR_MUN",
            label: "कृष्णनगर नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "ARGHAKHACHI_SANDHIKHARKA_MUN",
            label: "सन्धिखर्क नगरपालिका",
          },
          { value: "ARGHAKHACHI_SHITAGANGA_MUN", label: "शितगंगा नगरपालिका" },
          {
            value: "ARGHAKHACHI_BHUMIKASTHAN_MUN",
      ...
      {
        value: "nawalparasiSustaPaschchim",
        label: "नवलपरासी (बर्दघाट सुस्ता पश्चिम)",
        palikas: [
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_BARDAGHAT_MUN",
            label: "बर्दघाट नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_RAMGRAM_MUN",
            label: "रामग्राम नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_SUNAWAL_MUN",
            label: "सुनवल नगरपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_SUSTA_MUN",
            label: "सुस्ता गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_PALHINANDAN_MUN",
            label: "पाल्हीनन्दन गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_PRATAPPUR_MUN",
            label: "प्रतापपुर गाउँपालिका",
          },
          {
            value: "NAWALPARASI_SUSTA_PASCHCHIM_SARAWAL_MUN",
            label: "सरावल गाउँपालिका",
          },
        ],
      },
      {
        value: "rukumPurwa",
        label: "रुकुम (पूर्वी भाग)",
        palikas: [
          {
            value: "RUKUM_PURWA_PUTHA_UTTARGANGA_MUN",
            label: "पुथा उत्तरगंगा गाउँपालिका",
          },
    ...
    districts: [
      {
        ...
        palikas: [
          ...
          {
            value: "SALYAN_SIDDHA_KUMAKH_MUN",
            label: "सिद्ध कुमाख गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "SURKHET_BIRENDRANAGAR_MUN",
            label: "बीरेन्द्रनगर नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DAILEKH_CHAMUNDA_WINDRASAINI_MUN",
            label: "चामुण्डा विन्द्रासैनी नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DOLPA_TRIPURASUNDARI_MUN",
            label: "त्रिपुरासुन्दरी नगरपालिका",
          },
          ...
          {
            value: "DOLPA_CHHARKA_TANGSONG_MUN",
            label: "छार्का ताङसोङ गाउँपालिका",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "KALIKOT_SANNI_TRIWENI_MUN",
            label: "सान्नी त्रिवेणी गाउँपालिका",
          },
          { value: "KALIKOT_NARAHARINATH_MUN", label: "नरहरिनाथ गाउँपालिका" },
          {
            value: "KALIKOT_SHUBHA_KALIKA_MUN",
            label: "शुभ कालीका गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "MUGU_CHHAYANATH_RARA_MUN",
            label: "छायाँनाथ रारा नगरपालिका",
          },
          {
            value: "MUGU_MUGUM_KARMARONG_MUN",
            label: "मुगुम कार्मारोंग गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "RUKUM_PASCHIM_CHAURAJHARI_MUN",
            label: "चौरजहारी नगरपालिका",
          },
          {
            value: "RUKUM_PASCHIM_AATHBISKOT_MUN",
            label: "आठबिसकोट नगरपालिका",
          },
          { value: "RUKUM_PASCHIM_BAFIKOT_MUN", label: "बाँफिकोट गाउँपालिका" },
          { value: "RUKUM_PASCHIM_TRIWENI_MUN", label: "त्रिवेणी गाउँपालिका" },
          {
            value: "RUKUM_PASCHIM_SANI_BHERI_MUN",
            label: "सानी भेरी गाउँपालिका",
          },
        ],
      },
    ],
    ...
    districts: [
      {
        ...
        palikas: [
          ...
          {
            value: "BAJURA_SWAMIKARTIK_KHAPAR_MUN",
            label: "स्वामीकार्तिक खापर गाउँपालिका",
          },
          {
            value: "BAJURA_KHAPTAD_CHHEDEDAHA_MUN",
            label: "खप्तड छेडेदह गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "BAJHANG_KHAPTADCHHANNA_MUN",
            label: "खप्तडछान्ना गाउँपालिका",
          },
          ...
          {
            value: "BAJHANG_CHHABISPATHIBHERA_MUN",
            label: "छबिसपाथिभेरा गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "ACHHAM_PANCHADEWAL_WINAYEK_MUN",
            label: "पन्चदेवल विनायक नगरपालिका",
          },
          { value: "ACHHAM_CHAURPATI_MUN", label: "चौरपाटी गाउँपालिका" },
          { value: "ACHHAM_MELLEKH_MUN", label: "मेल्लेख गाउँपालिका" },
          {
            value: "ACHHAM_BANNIGADI_JAYAGAD_MUN",
            label: "बान्निगढी जयगढ गाउँपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          {
            value: "DOTI_DIPAYEL_SILAGADI_MUN",
            label: "दिपायल सिलगढी नगरपालिका",
          },
          ...
          {
            value: "DOTI_BOGTAN_FUDSIL_MUN",
            label: "बोगटान फुड्सिल गाउँपालिका",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "KANCHANPUR_MAHAKALI_MUN",
            label: "दोधारा चादँनी नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DADELDHURA_GANNYAPADHURA_MUN",
            label: "गन्यापधुरा गाउँपालिका",
          },
        ],
      },
      {
        ...
        palikas: [
          {
            value: "BAITADI_DASHARATHACHANDA_MUN",
            label: "दशरथचन्द नगरपालिका",
          },
      ...
      },
      {
        ...
        palikas: [
          ...
          {
            value: "DARCHULA_SHAILYASHIKHAR_MUN",
            label: "शैल्यशिखर नगरपालिका",
          },
